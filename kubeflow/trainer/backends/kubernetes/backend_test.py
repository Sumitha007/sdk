...
def get_train_job(
    ...
    train_job = models.TrainerV1alpha1TrainJob(
        ...
        spec=models.TrainerV1alpha1TrainJobSpec(
            runtimeRef=models.TrainerV1alpha1RuntimeRef(name=runtime_name,kind=runtime_kind.value if runtime_kind else None),
...
def create_runtime_type(
    name: str,
    kind: types.RuntimeKind | None = None,
) -> types.Runtime:
...
@pytest.mark.parametrize(
    ...
    [
        ...
        TestCase(
            ...
            expected_output=[
                create_runtime_type(name="runtime-1", kind=types.RuntimeKind.TRAINING_RUNTIME),
                create_runtime_type(name="ns-runtime-2", kind=types.RuntimeKind.TRAINING_RUNTIME),
                create_runtime_type(name="runtime-2", kind=types.RuntimeKind.CLUSTER_TRAINING_RUNTIME),
                create_runtime_type(name="runtime-3", kind=types.RuntimeKind.CLUSTER_TRAINING_RUNTIME),
            ],
        ),
        ...
        TestCase(
            ...
            expected_output=[
                create_runtime_type(name="runtime-1", kind=types.RuntimeKind.CLUSTER_TRAINING_RUNTIME),
                create_runtime_type(name="runtime-2", kind=types.RuntimeKind.CLUSTER_TRAINING_RUNTIME),
                create_runtime_type(name="runtime-3", kind=types.RuntimeKind.CLUSTER_TRAINING_RUNTIME),
            ],
        ),
